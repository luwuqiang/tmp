...
public class SolrIdentifierValidator {
    ...
    public static void validateCollectionName(String collectionName) throws Exception {
        validateCoreName(collectionName);
    }

    public static void validateCoreName(String name) {
        if (name == null || !identifierPattern.matcher(name).matches()) {
            ...
            throw new RuntimeException("Invalid name: '" + name + "' Identifiers must consist entirely of periods, hyphens, underscores and alphanumerics");
        }
    }
}
