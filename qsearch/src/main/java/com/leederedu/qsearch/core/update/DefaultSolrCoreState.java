...
import com.leederedu.qsearch.core.CoreContainer;
import com.leederedu.qsearch.core.CoreDescriptor;
import com.leederedu.qsearch.core.DirectoryFactory;
import com.leederedu.qsearch.core.SolrCore;
import com.leederedu.qsearch.core.cloud.ActionThrottle;
    ...
    private void lock(Lock lock) {
        ...
        do {
            ...
            if (closed) {
                ...
                //todo throw new Exception(ErrorCode.SERVICE_UNAVAILABLE, "SolrCoreState already closed.");
            }
        } while (!acquired);
    }
        ...
        if (iw != null) {
            if (!rollback) {
                try {
                    ...
                    //todo SolrException.log(log, "Error closing old IndexWriter. core=" + coreName, e);
                }
            } else {
                try {
                    ...
                    //todo  SolrException.log(log, "Error rolling back old IndexWriter. core=" + coreName, e);
                }
            }
        }
