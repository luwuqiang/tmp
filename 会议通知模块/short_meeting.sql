CREATE TABLE `t_meeting_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16010000000000 DEFAULT CHARSET=utf8 COMMENT='会议通知模块';
...
INSERT INTO `t_sys_prefix_sno` (`lastno`, `note_id`, `opertype`, `prefix`) VALUES (16010000000000, 1, 1, 16);
