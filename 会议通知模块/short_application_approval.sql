CREATE TABLE `t_mo_application` (
  ...
  `photo_group_id` bigint(20) DEFAULT NULL COMMENT '图组id,关联t_sys_file_info的obj_id',
  `state` tinyint(4) DEFAULT '1' COMMENT '0:已读,1:未读',
  PRIMARY KEY (`id`)
...
CREATE TABLE `t_mo_application_account` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='财务申请表';
...
CREATE TABLE `t_mo_application_account_item` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='报销明细表';
...
CREATE TABLE `t_mo_application_out` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='外出申请表';
...
CREATE TABLE `t_mo_application_purchase_item` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='采购明细';
...
CREATE TABLE `t_mo_approval` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='审批表';
...
CREATE TABLE `t_mo_approval_step_mold_item` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='审批流程模型明细项';
